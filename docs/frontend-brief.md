...
| POST | `/accounts` | Tạo ví mới |
| PUT | `/accounts/:id` | Cập nhật tên/thông tin ví |
| DELETE | `/accounts/:id` | Xóa ví |
| POST | `/accounts/:id/sync` | Đồng bộ giao dịch ngân hàng thủ công |
...
```json
{
  ...
  "balance": "1500000.00",
  "currency": "VND",
  "lastSyncedAt": "2024-06-17T07:00:00.000Z",
  "createdAt": "...",
  "updatedAt": "..."
}
```
...
## 4. Categories — Danh mục giao dịch
...
## 5. Budgets — Hũ chi tiêu (Money Pots)
